...
//creation of viewModel
 ...
 var locations = [
          {title: 'Zilker Botanical Garden', location: {lat: 30.269501, lng: -97.772644},flag:false},
          {title: 'Austin Nature & Science Center', location: {lat: 30.2721499, lng: -97.7748158},flag:false},
          {title: 'Texas Capitol, Austin', location: {lat: 30.2746652, lng: -97.740350},flag:false},
          {title: 'Mayfield Park and Nature Preserve', location: {lat: 30.3129736, lng: -97.77162000000001},flag:false},
          {title: 'Graffiti Park at Castle Hill', location: {lat: 30.276165, lng: -97.753309},flag:false},
          {title: 'Lady Bird Johnson Wildflower ', location: {lat: 30.1854455, lng: -97.8732112},flag:false}
        ];
 ...
 // Initialize the distance matrix service.
      ...
      function initMap() {
        ...
        map = new google.maps.Map(document.getElementById('map'), {
          ...
          center: {lat: 30.267153, lng: -97.74306}, 
          zoom: 13,
          styles: styles,
